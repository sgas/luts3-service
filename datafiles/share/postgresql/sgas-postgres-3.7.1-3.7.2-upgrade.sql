-- logic for upgrading the SGAS PostgreSQL schema from version 3.7.1 to 3.7.2
-- SGAS should preferable be stopped when performing this upgrade

DROP FUNCTION IF EXISTS urcreate ( character varying, timestamp without time zone, character varying, character varying, character varying, character varying, character varying, character varying, character varying, character varying[], character varying, character varying, integer, character varying, character varying, character varying, integer, integer, character varying, character varying, timestamp without time zone, timestamp without time zone, timestamp without time zone, integer, integer, integer, integer, integer, character varying[], integer, character varying[], character varying[], character varying, character varying, timestamp without time zone);
DROP FUNCTION IF EXISTS urcreate ( varchar, timestamp, varchar, varchar, varchar, varchar, varchar, varchar, varchar, varchar[][], varchar, varchar, integer, varchar, varchar, varchar, integer, integer, varchar, varchar, timestamp, timestamp, timestamp, bigint, integer, integer, integer, integer, varchar[], integer, varchar[], varchar[], varchar, varchar, timestamp);

CREATE TYPE sgas_memory AS ( memory BIGINT, metric TEXT, type TEXT );

ALTER TABLE usagedata ADD COLUMN memory sgas_memory[];
